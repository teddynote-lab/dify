const translation = {
  ...
  members: {
    ...
    resetPasswordConfirm: '이 사용자의 비밀번호를 초기화하시겠습니까?',
    resetPasswordSuccess: '비밀번호가 초기화되었습니다. 새 비밀번호: {{password}}',
    resetPasswordTip: '새로운 비밀번호를 안전한 곳에 저장하세요.',
    passwordResetSuccess: '비밀번호 초기화 완료',
    passwordResetSuccessDesc: '사용자의 비밀번호가 성공적으로 초기화되었습니다.',
    newPassword: '새 비밀번호',
    passwordSecurityWarning: '⚠️ 이 비밀번호를 안전한 곳에 저장하세요. 이 창을 닫으면 다시 확인할 수 없습니다.',
    sendViaEmail: '이메일로 전송',
    sendingEmail: '전송 중...',
    passwordEmailSent: '비밀번호가 이메일로 전송되었습니다.',
    passwordEmailFailed: '이메일 전송에 실패했습니다.',
  },
  integrations: {
    connected: '연결됨',
    google: 'Google',
