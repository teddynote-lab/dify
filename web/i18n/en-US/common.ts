const translation = {
  ...
  members: {
    ...
    resetPasswordSuccess: 'Password has been reset. New password: {{password}}',
    resetPasswordTip: 'Please save the new password in a secure place.',
    passwordResetSuccess: 'Password Reset Successful',
    passwordResetSuccessDesc: 'The user\'s password has been successfully reset.',
    newPassword: 'New Password',
    passwordSecurityWarning: '⚠️ Please save this password in a secure place. You won\'t be able to see it again after closing this window.',
    sendViaEmail: 'Send via Email',
    sendingEmail: 'Sending...',
    passwordEmailSent: 'Password has been sent via email.',
    passwordEmailFailed: 'Failed to send email.',
    transferModal: {
